...
{
    public class MessengerHandlerSubscriberComponentTest : UnitTestBase
    {
        #region Methods
        ...
        public void TrySubscribeUnsubscribeShouldReturnFalseNotSupported()
        {
            ...
            var component = new MessengerHandlerSubscriberComponent();
            messenger.AddComponent(component);

            component.TrySubscribe(this, null, DefaultMetadata).ShouldBeFalse();
            component.TryGetSubscribers(null).ShouldBeNull();
        ...
        public void TrySubscribeUnsubscribeGetAllTest(int count)
        {
            ...
            var subscribers = component.TryGetSubscribers(DefaultMetadata)!;
            ...
            component.TryGetSubscribers(DefaultMetadata).ShouldBeNull();
        }
