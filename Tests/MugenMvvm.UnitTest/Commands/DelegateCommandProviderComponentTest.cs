...
{
    public class DelegateCommandProviderComponentTest : UnitTestBase
    {
        #region Fields

        private readonly DelegateCommandProviderComponent _component;

        #endregion

        #region Constructors

        public DelegateCommandProviderComponentTest()
        {
            _component = new DelegateCommandProviderComponent();
        }
