...
{
    public class NavigationEntryFinderComponentTest : UnitTestBase
    {
        #region Fields

#pragma warning disable CS8618
        private NavigationEntryFinderComponent _component;
...
#pragma warning restore CS8618
        ...
        private void GenerateData(int count)
        {
            ...
            _component = new NavigationEntryFinderComponent();
