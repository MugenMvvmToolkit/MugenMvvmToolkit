...
namespace MugenMvvm.UnitTest.Collections.Components
{
    public class DecoratorManagerObservableCollectionComponentTest : UnitTestBase
    {
        ...
        public void DecoratorShouldDecorateItems()
        {
            ...
            collection.AddComponent(new DecoratorManagerObservableCollectionComponent<TestCollectionItem>());
        ...
        public void DecoratorShouldTrackItemsMulti2(bool defaultComparer, bool filterFirst)
        {
            ...
            observableCollection.AddComponent(new DecoratorManagerObservableCollectionComponent<TestCollectionItem>());
