...
namespace MugenMvvmToolkit.Infrastructure
{
    ...
    public abstract class InitializationModuleBase : ModuleBase
    {
        ...
        /// <summary>
        ///     Gets the <see cref="IViewModelWrapperManager" /> that will be used by default.
        /// </summary>
        /// <returns>An instance of <see cref="IViewModelWrapperManager" />.</returns>
        protected virtual BindingInfo<IViewModelWrapperManager> GetViewModelWrapperManager()
        {
            return BindingInfo<IViewModelWrapperManager>.Empty;
        }
