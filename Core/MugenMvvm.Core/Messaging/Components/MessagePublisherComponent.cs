...
{
    public sealed class MessagePublisherComponent : LightDictionary<Type, MessagePublisherComponent.ThreadExecutionModeDictionary?>, IMessagePublisherComponent, IHasPriority,
        IAttachableComponent, IDetachableComponent, IHasCache
    {
        ...
        public MessagePublisherComponent(IThreadDispatcher? threadDispatcher = null) : base(3)
        {
