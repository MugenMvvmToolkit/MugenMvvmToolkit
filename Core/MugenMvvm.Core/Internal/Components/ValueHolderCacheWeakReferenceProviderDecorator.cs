...
{
    public sealed class ValueHolderCacheWeakReferenceProviderDecorator : DecoratorComponentBase<IWeakReferenceProvider, IWeakReferenceProviderComponent>, IWeakReferenceProviderComponent, IHasPriority
    {
        #region Properties
