...
{
    public sealed class ValueHolderCacheDecoratorWeakReferenceProviderComponent : DecoratorComponentBase<IWeakReferenceProvider, IWeakReferenceProviderComponent>, IWeakReferenceProviderComponent, IHasPriority
    {
        #region Properties
