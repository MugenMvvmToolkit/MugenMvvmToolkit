...
{
    public sealed class CacheMemberManagerDecorator : DecoratorComponentBase<IMemberProvider, IMemberManagerComponent>, IMemberManagerComponent, IHasPriority, IHasCache
    {
        #region Fields
