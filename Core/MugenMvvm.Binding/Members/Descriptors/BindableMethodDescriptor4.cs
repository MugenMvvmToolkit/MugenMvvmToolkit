...
namespace MugenMvvm.Binding.Members.Descriptors
{
    ...
    public readonly struct BindableMethodDescriptor<TTarget, TArg1, TArg2, TArg3, TArg4, TReturn> where TTarget : class
    {
        ...
        public Type[] Types => Default.Types<TArg1, TArg2, TArg3, TArg4>();
        ...
        [Pure]
        public BindableMethodDescriptor<TNewTarget, TArg1, TArg2, TArg3, TArg4, TReturn> Override<TNewTarget>() where TNewTarget : class => Name;

        public static implicit operator BindableMethodDescriptor<TTarget, TArg1, TArg2, TArg3, TArg4, TReturn>(string name) => new BindableMethodDescriptor<TTarget, TArg1, TArg2, TArg3, TArg4, TReturn>(name);

        public static implicit operator string(BindableMethodDescriptor<TTarget, TArg1, TArg2, TArg3, TArg4, TReturn> member) => member.Name;
