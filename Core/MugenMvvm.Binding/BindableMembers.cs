...
namespace MugenMvvm.Binding
{
    public static class BindableMembers
    {
        ...
        public abstract class Object
        {
            ...
            public static readonly BindableMethodDescriptor<object, object?> ElementSource = nameof(ElementSource);
            public static readonly BindableMethodDescriptor<object, object?> RelativeSource = nameof(RelativeSource);
            public static readonly BindableMethodDescriptor<object, object?> FindByName = "FindElementByName";
