...
{
    public sealed class ModeBindingInitializerComponent : IBindingExpressionInitializerComponent, IHasPriority
    {
        #region Constructors

        public ModeBindingInitializerComponent()
        {
            BindingModes = new Dictionary<string, object>();
            DefaultMode = OneWayBindingModeComponent.Instance;
        }
