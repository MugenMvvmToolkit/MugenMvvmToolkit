    ...
    public class CollectionViewManager : ICollectionViewManager
    {
        protected static ItemsSourceBindableCollectionAdapter? GetCollectionAdapter(object collectionView, bool throwIfNotSupported)
        {
            ...
            if (throwIfNotSupported)
                ExceptionManager.ThrowInvalidBindingMember(collectionView, nameof(IosBindableMembers.ItemsSource));
            return null;
        }
        ...
        {
            ExceptionManager.ThrowInvalidBindingMember(collectionView, nameof(IosBindableMembers.SelectedItem));
            return null;
        }
