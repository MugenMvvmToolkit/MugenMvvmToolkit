...
namespace MugenMvvm.Android.Native.Views.Fragments
{
    ...
    [Register("com/mugen/mvvm/views/fragments/MugenAppCompatDialogFragment", DoNotGenerateAcw = true)]
    public partial class MugenAppCompatDialogFragmentLite : Object, IDialogFragmentView, INativeFragmentView
    {
        private static readonly JniPeerMembers _members = new XAPeerMembers("com/mugen/mvvm/views/fragments/MugenAppCompatDialogFragment", typeof(MugenDialogFragmentLite));
        ...
        [Register(".ctor", "()V", "")]
        public unsafe MugenAppCompatDialogFragmentLite()
        ...
        protected MugenAppCompatDialogFragmentLite(IntPtr javaReference, JniHandleOwnership transfer) : base(javaReference, transfer)
        {
        }
