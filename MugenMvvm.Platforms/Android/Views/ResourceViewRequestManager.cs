            ...
            IReadOnlyMetadataContext? metadata)
        {
            if (mapping.IsUndefined() && request is ResourceViewRequest viewRequest && viewRequest.ViewModel != null && viewRequest.Container is Object container)
            {
                ...
                if (viewMapping != null || viewRequest.ResourceId != 0)
                {
                    ...
                    var view = ViewMugenExtensions.GetView(container, resourceId, true, viewMapping?.Bundle!);
            ...
            else if (mapping is IResourceViewMapping resourceViewMapping)
            {
                ...
                view ??= ViewMugenExtensions.GetView(TryGetParentView(viewManager, viewModel, metadata)!, resourceViewMapping.ResourceId, true, resourceViewMapping.Bundle!);
