...
namespace MugenMvvm.Android.Bindings
{
    public static class ViewBindableMembers
    {
        ...
        public static BindablePropertyDescriptor<T, bool> IsFocused<T>(this BindableMembersDescriptor<T> _) where T : View => nameof(IsFocused);
        ...
        public static BindableEventDescriptor<T> ImeAction<T>(this BindableMembersDescriptor<T> _) where T : View => nameof(ImeAction);
        ...
        public static BindableEventDescriptor<T> FocusChanged<T>(this BindableMembersDescriptor<T> _) where T : View => nameof(FocusChanged);
