...
namespace MugenMvvm.UnitTest.Binding.Members.Builders
{
    public class EventBuilderTest : UnitTestBase
    {
        ...
        [Fact]
        public void StaticAutoGeneratedShouldRaise()
        {
            var message = "m";
            var memberInfo = new EventBuilder<object>("t", typeof(object), typeof(EventHandler)).Static().Build();
            ...
            memberInfo.Raise(null, message, DefaultMetadata);
        ...
        [InlineData(true)]
        [InlineData(false)]
        public void InstanceAutoGeneratedShouldRaise(bool withAttachedHandler)
        {
            var message = "m";
