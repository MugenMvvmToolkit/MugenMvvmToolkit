...
{
    public class UnaryTokenTypeTest
    {
        #region Methods
        ...
        {
            var enum1 = UnaryTokenType.StaticExpression;
            var enum2 = UnaryTokenType.BitwiseNegation;
            var enum3 = new UnaryTokenType(enum1.Value);
            var v1 = enum1.Value;
            var v2 = enum2.Value;
