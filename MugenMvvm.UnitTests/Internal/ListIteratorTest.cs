...
{
    public class ListIteratorTest : UnitTestBase
    {
        #region Methods
        ...
        {
            var iterator = new ListIterator<object, List<object>>(0, null, null);
            try
            {
                var o = iterator[0];
        ...
        public void IndexCountEnumeratorShouldBeCorrect(int count)
        {
            ...
            var iterator = new ListIterator<object, List<object>>(count, itemOrList.Item, itemOrList.List);
