...
{
    public class ThreadExecutionModeTest
    {
        #region Methods
        ...
        {
            var enum1 = ThreadExecutionMode.Main;
            var enum2 = ThreadExecutionMode.MainAsync;
            var enum3 = new ThreadExecutionMode(enum1.Value);
            var v1 = enum1.Value;
            var v2 = enum2.Value;
