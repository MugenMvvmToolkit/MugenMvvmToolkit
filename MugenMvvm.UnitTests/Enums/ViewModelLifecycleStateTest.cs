...
{
    public class ViewModelLifecycleStateTest
    {
        [Fact]
        public void CompareToEqualsShouldBeValid()
        {
            var enum1 = ViewModelLifecycleState.Initialized;
            var enum2 = ViewModelLifecycleState.Initializing;
            var enum3 = new ViewModelLifecycleState(enum1.Value);
            var v1 = enum1.Value;
            var v2 = enum2.Value;
