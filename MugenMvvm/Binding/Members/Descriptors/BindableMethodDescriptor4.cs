...
namespace MugenMvvm.Binding.Members.Descriptors
{
    ...
    public readonly struct BindableMethodDescriptor<TTarget, TArg1, TArg2, TArg3, TArg4, TReturn> where TTarget : class
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BindableMethodDescriptor<TTarget, TArg1, TArg2, TArg3, TArg4, TReturn>(MemberTypesRequest request) => new BindableMethodDescriptor<TTarget, TArg1, TArg2, TArg3, TArg4, TReturn>(request);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BindableMethodDescriptor<TTarget, TReturn>(BindableMethodDescriptor<TTarget, TArg1, TArg2, TArg3, TArg4, TReturn> member) => new BindableMethodDescriptor<TTarget, TReturn>(member.Request);
