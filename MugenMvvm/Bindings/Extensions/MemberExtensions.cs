...
namespace MugenMvvm.Bindings.Extensions
{
    public static partial class BindingMugenExtensions
    {
        ...
        public static IMethodMemberInfo? TryGetMember<TTarget, TValue>(this BindableMethodDescriptor<TTarget, TValue> bindableMember, Type? type = null,
            EnumFlags<MemberFlags> flags = default,
            IReadOnlyMetadataContext? metadata = null, IMemberManager? memberManager = null)
            where TTarget : class =>
            memberManager
                .DefaultIfNull()
                .TryGetMembers(type ?? typeof(TTarget), MemberType.Method, flags.GetDefaultFlags().SetInstanceOrStaticFlags(bindableMember.IsStatic), bindableMember.Request!,
                    metadata)
        ...
        public static IAccessorMemberInfo? TryGetMember<TTarget, TValue>(this BindablePropertyDescriptor<TTarget, TValue> bindableMember,
            ...
            memberManager
                .DefaultIfNull()
                .TryGetMembers(type ?? typeof(TTarget), MemberType.Accessor, flags.GetDefaultFlags().SetInstanceOrStaticFlags(bindableMember.IsStatic), bindableMember.Name,
                    metadata)
        ...
        public static IMemberInfo? TryGetMember(this IMemberManager memberManager, Type type, EnumFlags<MemberType> memberTypes, EnumFlags<MemberFlags> flags, object request,
        ...
        public static TReturn Invoke<TTarget, TReturn>(this BindableMethodDescriptor<TTarget, TReturn> methodMember, TTarget target,
            ItemOrArray<object?> args, EnumFlags<MemberFlags> flags = default, IReadOnlyMetadataContext? metadata = null, IMemberManager? memberManager = null)
            where TTarget : class
        {
            Should.NotBeNull(target, nameof(target));
        ...
        public static TReturn Invoke<TTarget, TArg1, TArg2, TArg3, TArg4, TArg5, TReturn>(
            this BindableMethodDescriptor<TTarget, TArg1, TArg2, TArg3, TArg4, TArg5, TReturn> methodMember, TTarget target,
        ...
        {
            Should.NotBeNull(target, nameof(target));
            (bindableMember.TryGetMember(GetTargetType(bindableMember.IsStatic, ref target!), flags, metadata, memberManager) as INotifiableMemberInfo)?.Raise(target, message,
                metadata);
        }
        ...
        {
            Should.NotBeNull(target, nameof(target));
            (methodMember.TryGetMember(GetTargetType(methodMember.IsStatic, ref target!), flags, metadata, memberManager) as INotifiableMemberInfo)?.Raise(target, message,
                metadata);
        }

        internal static ActionToken TryObserve(this IObservableMemberInfo observableMember, IMemberInfo _, object? target, IEventListener listener,
            IReadOnlyMetadataContext? metadata) =>
            observableMember.TryObserve(target, listener, metadata);

        internal static void Raise(this INotifiableMemberInfo notifiableMember, IMemberInfo _, object? target, object? message, IReadOnlyMetadataContext? metadata) =>
            notifiableMember.Raise(target, message, metadata);
