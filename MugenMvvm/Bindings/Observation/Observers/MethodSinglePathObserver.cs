...
namespace MugenMvvm.Bindings.Observation.Observers
{
    public sealed class MethodSinglePathObserver : SinglePathObserver, ObserverBase.IMethodPathObserver
    {
        ...
        public MethodSinglePathObserver(string method, object target, IMemberPath path, EnumFlags<MemberFlags> memberFlags, bool optional, bool isWeak)
            : base(target, path, memberFlags, optional, isWeak)
        {
