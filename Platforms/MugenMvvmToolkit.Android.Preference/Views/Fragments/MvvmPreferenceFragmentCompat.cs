...
// ****************************************************************************
// <copyright file="MvvmPreferenceFragmentCompat.cs">
...
namespace MugenMvvmToolkit.Android.PreferenceCompat.Views.Fragments
{
    public abstract class MvvmPreferenceFragmentCompat : PreferenceFragmentCompat, IFragmentView
    {
        #region Fields
        ...
        protected MvvmPreferenceFragmentCompat(IntPtr javaReference, JniHandleOwnership transfer)
            : base(javaReference, transfer)
        {
        }

        protected MvvmPreferenceFragmentCompat(int? viewId = null)
        {
            _viewId = viewId;
        }
