...
namespace MugenMvvmToolkit.Android.Infrastructure.Navigation
{
	public class NavigationService : INavigationService
	{
		...
		private static int _activityCounter;
		...
		protected virtual bool IsTaskRoot(Activity activity)
		{
			if (activity.IsTaskRoot)
				return true;
			return !AndroidToolkitExtensions.IsApiGreaterThanOrEqualTo21 && _activityCounter < 2;
		}
